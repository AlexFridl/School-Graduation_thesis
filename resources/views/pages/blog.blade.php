                            ...
                            @foreach($blog as $b)
                                <article class="blog_item ">
                                    ...
                                    <div class="blog_details ">
                                        <a class="d-inline-block" href="{{route('one_Blog',['id_blog'=>$b->id_blog])}}">
                                            <h2>{{$b->naslov_blog}}</h2>
                                        </a>
                                        ...
                                        <b><a href="{{route('one_Blog',['id_blog'=>$b->id_blog])}}" style="color:#B08EAD;">Više</a></b>
                                    </div>
                                </article>
                            @endforeach
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget search_widget">
                            ...
                            <input class="button rounded-0 primary-bg text-white w-100 btn_1 btnSearch" name="btnSearch" id="btnSearch"
