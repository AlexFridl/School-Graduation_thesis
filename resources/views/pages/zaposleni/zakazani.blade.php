    ...
    <div>
        <div class="divAdminTable">
            ...
            <div style="margin-left: 600px;padding-bottom: 10px;">
                ...
                <input type="date"name="sortByDate" id="sortByDate"/>
            </div>
            <div id="ispis">
                ...
                @foreach($zakazani as $z)
                    <tr>
                        ...
                        @else
                            <td>Zakazano</td>
                        @endif
                        <td><a class="linkA"  href="{{route('zakazani_update',['id_zakazano'=>$z->id_zakazano])}}">Izmeni</a></td>
                        @if($z->status_termina == '0')
                            <td>Otkazano</td>
                        @else
                            <td><a  class="linkA"  href="{{route('zakazani_delete',['id_zakazano'=>$z->id_zakazano])}}">Otkaži</a></td>
                        @endif
                    </tr>
                @endforeach
                </tbody>
